const Navigation = () => {
    return (
        <div>
            <div
                className="border bg-gray-50 shadow-sm border-gray-200 dark:bg-gray-800 dark:border-gray-700 p-4 flex flex-col sm:flex-row items-center justify-between">
                <div className="w-full sm:flex">
                    <div className="relative w-full sm:mr-3 mb-3 sm:mb-0">
